...
contract Notes {
    ...
    mapping (address => bool) kmaasPublicKeys;
    ...
    function proxy(bytes memory data) external payable {
        // Check whether this function call is coming from a user of the service
        require(kmaasPublicKeys[msg.sender], "Caller is not authorized");
    ...
    function createUser(address validatorAddress,
        ...
        kmaasPublicKeys[kmaas.publicKey()] = true;
